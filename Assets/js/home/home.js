const projects = {
  polyverse: {
    ...
    link: "polyverse.html",
    localLink: "projects/product-design-b2c/polyverse.html"
  },
  "dollar-flip": {
    title: "Dollar Flip",
    ...
    localLink: "projects/product-design-b2c/dollar-flip.html"
  },
  uircs: {
    title: "UIRCS",
    ...
    media: "static/picture/home/uircs-preview-20260817.png",
    mediaType: "image",
...
document.querySelectorAll("[data-project]").forEach((card) => {
  ...
  card.addEventListener("click", () => {
    ...
    Object.entries(fields).forEach(([key, element]) => {
      ...
      else if (key === "link") element.href = window.location.protocol === "file:" ? data.localLink : data.link;
...
document.addEventListener("click", (event) => {
  if (!event.target.closest(".hpr-menu-toggle") && !event.target.closest(".hpr-nav-links")) closeMenu();
});
